 ...
 ******************************************************************************/
package eu.iescities.pilot.rovereto.inbici.entities.search;
...
import eu.iescities.pilot.rovereto.inbici.custom.SearchHelper;
			...
			public void onClick(View view) {
				...
				if (CategoryHelper.CATEGORY_TYPE_EVENTS.equals(type)) {
					if (selectedWhen == null) {
						...
						passedWhen = new WhenForSearch("", TimeUtils.getCurrentDateTimeForSearching(), 0);
					} else {
						passedWhen = new WhenForSearch("", TimeUtils.getCurrentDateTimeForSearching()
								+ selectedWhen.getFrom(), TimeUtils.getCurrentDateTimeForSearching()
				...
				fragmentTransaction.replace(R.id.content_frame, fragment, type);
