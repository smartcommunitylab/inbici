...
import eu.iescities.pilot.rovereto.inbici.utils.frechetdistance.algo.util.VectorUtil;
...
public class PolyhedralUpperEnvelope implements UpperEnvelope {
    ...
    protected class FacetList extends Deque<FacetListElement> {
    ...
    protected class FacetListElement extends DequeItem<FacetListElement> {
