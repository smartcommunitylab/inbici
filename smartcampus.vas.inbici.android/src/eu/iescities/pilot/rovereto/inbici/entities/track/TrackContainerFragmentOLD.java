...
public class TrackContainerFragmentOLD extends Fragment {
	...
	public static TrackContainerFragmentOLD newInstance(String id) {
		TrackContainerFragmentOLD fragment = new TrackContainerFragmentOLD();
...
//			abActivity.finish();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		ViewGroup viewGroup = (ViewGroup) inflater.inflate(R.layout.fragment_track_container_old, container, false);
