...
public class Constants
{
   ...
   public static final String SERVICENAME = "eu.iescities.pilot.rovereto.inbici.intent.action.GPSLoggerService";
   public static final String STREAMBROADCAST = "eu.iescities.pilot.rovereto.inbici.intent.action.STREAMBROADCAST";
   ...
   public static final String LOGGING_STATE_CHANGED_ACTION = "eu.iescities.pilot.rovereto.inbici.LOGGING_STATE_CHANGED";
    ...
    * 
    */
   public static final String EXTRA_LOGGING_PRECISION = "eu.iescities.pilot.rovereto.inbici.EXTRA_LOGGING_PRECISION";
    ...
    * @see #STOPPED
    */
   public static final String EXTRA_LOGGING_STATE = "eu.iescities.pilot.rovereto.inbici.EXTRA_LOGGING_STATE";
...
//   public static final String OSM_AUTHORIZE_URL = "http://www.openstreetmap.org/oauth/authorize";
    ...
    */
   public static final String EXTRA_DISTANCE = "eu.iescities.pilot.rovereto.inbici.EXTRA_DISTANCE";
   /**
    * A time period in minutes
    */
   public static final String EXTRA_TIME = "eu.iescities.pilot.rovereto.inbici.EXTRA_TIME";
   /**
    * The location that pushed beyond the set minimum time or distance 
    */
   public static final String EXTRA_LOCATION = "eu.iescities.pilot.rovereto.inbici.EXTRA_LOCATION";
   /**
    * The track that is being logged
    */
   public static final String EXTRA_TRACK =  "eu.iescities.pilot.rovereto.inbici.EXTRA_TRACK";
