 ...
 ******************************************************************************/
package eu.iescities.pilot.rovereto.inbici.entities.training;
...
public class TrainingPlaceholder {
	public TrainingObject training;
	public TextView numberOfTraining,startTime, durationTime; // description;
	public TextView totalDistance;
	public TextView totalDifference;
